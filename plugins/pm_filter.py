...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, PICS, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, \
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 Updates', url='https://t.me/Malayalam_Kaduva_Movies_Mallu_HD')
        ], [
            InlineKeyboardButton('ℹ️ Help', callback_data='to_help')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.reply_photo(
            photo=random.choice(PICS),
            caption=script.START_TXT.format(query.message.from_user.mention, temp.U_NAME, temp.B_NAME),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖Updates', url=f'https://t.me/Malayalam_Kaduva_Movies_Mallu_HD')
        ],[
...
#try new
        ...
        await query.message.delete()
        await query.message.reply_sticker(
            'CAACAgUAAxkBAAEBI79iqMLJrQKv29CMpzORgsywQ7N_eAACjAYAAlJuWVZyrxMDtBmVryQE',
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton('❤️‍🔥JNS❤️‍🔥', url=f'http://t.me/JINTONS')
